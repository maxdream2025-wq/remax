...
const SearchResult = ({ properties = [], searchError = null, searchParams = {} }) => {
                        ...
                        <div className="col-md-8 p-4">
                          ...
                          <ul className="list-group list-group-flush mb-3">
                            <li className="list-group-item">
                              <div className="row">
                                <div className="col-12">
                                  <strong>Location:</strong> {prop.location_search || prop.location}
                                </div>
                              </div>
                            </li>
                            <li className="list-group-item">
                            ...
                            <li className="list-group-item">
                              <div className="row">
                                ...
                                <div className="col-6">
                                  <strong>Area:</strong> {prop.area?.min_sqft} - {prop.area?.max_sqft} sqft
                                </div>
                              </div>
                            </li>
                            <li className="list-group-item">
                              <div className="row">
                                <div className="col-6">
                                  <strong>Starting Price:</strong> AED {parseFloat(prop.starting_price).toLocaleString()}
                                </div>
                                <div className="col-6">
