...
const Contactus = () => {
    ...
    return (
        <>
            <MetaData 
                title="Contact Us | RE/MAX UAE | RE/MAX UAE " 
            ...
            <section className="contact_page contactmain bg-white" id="our_remax">
                <div className="full-bg-section rm_banner contactbgmain" id="">
                    <div className="egypt_branding desktop">
                        <img
                            src="https://remax.ae/assets/img/icons/Contact_us.svg"
                            alt="Contact us"
                        />
                    </div>
                </div>
                ...
                <div className="container-fluid" style={{ paddingBottom: "50px" }}>
                    <div className="row">
                        <div className="col-12">
                            <h1 className="text-center text-lg-left">HOW CAN WE HELP YOU?</h1>
                        </div>
                    </div>
                                ...
                                <div className="row g-3">
                                    <div className="col-md-12">
                                        ...
                                        <select
                                            ...
                                            required
                                            value={formValues.help_category}
                                            onChange={handleChange}
                                        >
                                            <option value="">Select Help Category</option>
                                            <option value="Buy a Property">Buy a Property</option>
                                            <option value="Become a REMAX Agent">Become a REMAX Agent</option>
                                            <option value="Find a REMAX Office">Find a REMAX Office</option>
                                            <option value="Find a REMAX Agent">Find a REMAX Agent</option>
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        >
                                            ...
                                            <option value="+500">South Georgia and the South Sandwich
                                                Islands (+500)</option>
                                    ...
                                    {submitStatus.message && (
                                        <div className="col-md-12">
                                            <div className={submitStatus.ok ? "alert alert-success" : "alert alert-danger"}>
                                                {submitStatus.message}
                                            </div>
                                        </div>
                                    )}
